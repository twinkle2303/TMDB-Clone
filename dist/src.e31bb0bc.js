...
const API_KEY = "ce826d161bb65d05476c637154c91643";
...
async function fetchSearchResult(query) {
  ...
  https://api.themoviedb.org/3/search/movie?api_key=${_config.API_KEY}&language=en-US&query=${query}&page=1&include_adult=false`);
  let data = await result.json();
  return data;
}
...
async function loadPopularData() {
  ...
  let {
    results
  } = await (0, _model.fetchPopularMovies)();
...
_base.elements.form.addEventListener("submit", async e => {
  ...
  let {
    results
  } = await (0, _model.fetchSearchResult)(searchresult.trim());
  (0, _view.renderCards)(results);
});
},{"./model":"model.js","./view/view":"view/view.js","./view/base":"view/base.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
